    ...
    <footer className="section" style={{ paddingTop:40, paddingBottom:60 }}>
      <div className="container">
        ...
        <div style={{ display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:16 }}>
          ...
          <p style={{ fontFamily:"var(--font-code)", fontSize:10, letterSpacing:"0.3em", textTransform:"uppercase", color:"var(--t3)", textAlign:"center" }}>
            Designed &amp; Built by Ridham Pokiya &mdash; {new Date().getFullYear()}
          </p>
          <div style={{ display:"flex", alignItems:"center", gap:8, fontFamily:"var(--font-code)", fontSize:10, letterSpacing:"0.15em", textTransform:"uppercase", color:"var(--t3)" }}>
